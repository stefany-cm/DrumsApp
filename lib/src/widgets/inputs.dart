...
Widget inputPassword(TextEditingController passwordControler) {
  return TextFormField(
    obscureText: false,
...
Widget inputConfirmationPassword(TextEditingController passwordControler) {
  return TextFormField(
    obscureText: true,
    decoration: const InputDecoration(
